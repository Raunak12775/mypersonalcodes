// for 1st 5 states for Simple Harmonic Oscillator
//
...
static double Harmonic_Potential(const coord_1d &r) {
    ...
    double x = r[0];
    return 0.5 * (x * x) - shift;
//    return 0.5 * (x * x) - shift + 3.0*exp(-3.0*x*x); // this is for Double Well potential
}
